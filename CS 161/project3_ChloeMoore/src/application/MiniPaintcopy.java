...
public class MiniPaintcopy extends Application {
	...
	EventHandler<MouseEvent> shape_updater = new UpdateShape();
	...
	public void start(Stage stage) throws Exception {
		...
		draw_radio.setOnAction(new EventManager());
		move_radio.setOnAction(new EventManager());
		delete_radio.setOnAction(new EventManager());
	...
	public void manage_eventhandlers () {
		if (draw_radio.isSelected()) {
			...
			draw_pane.addEventHandler(MouseEvent.MOUSE_DRAGGED, shape_updater);
			...
			draw_pane.removeEventHandler(MouseEvent.MOUSE_DRAGGED, shape_updater);
			for (Shape shape : collection.get_all_shapes()) {
				shape.removeEventHandler(MouseEvent.MOUSE_CLICKED, shape_deleter);
			}
	...
	class EventManager implements EventHandler<ActionEvent> {
		@Override
