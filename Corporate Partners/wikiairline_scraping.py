...
df_airlines = pd.DataFrame(all_airlines, columns=["Airline"])
airlines_trimmed = df_airlines[df_airlines["Airline"].str[0].isin(letters)]

df_counts = airlines_trimmed.groupby("Airline").size()
print(df_counts)
